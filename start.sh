...
echo -e "${DIM}  ┌──────────────────────────────────────────────────────────────────────┐${D}"
echo -e "${DIM}  │${D}                                                                      ${DIM}│${D}"
echo -e "${DIM}  │${D}  ${R}${B}██████╗ ██████╗  ██████╗ ███╗   ███╗██████╗ ████████╗${D}              ${DIM}│${D}"
echo -e "${DIM}  │${D}  ${R}${B}██╔══██╗██╔══██╗██╔═══██╗████╗ ████║██╔══██╗╚══██╔══╝${D}              ${DIM}│${D}"
echo -e "${DIM}  │${D}  ${R}${B}██████╔╝██████╔╝██║   ██║██╔████╔██║██████╔╝   ██║${D}                ${DIM}│${D}"
echo -e "${DIM}  │${D}  ${Y}${B}██╔═══╝ ██╔══██╗██║   ██║██║╚██╔╝██║██╔═══╝    ██║${D}                ${DIM}│${D}"
echo -e "${DIM}  │${D}  ${Y}${B}██║     ██║  ██║╚██████╔╝██║ ╚═╝ ██║██║        ██║${D}                ${DIM}│${D}"
echo -e "${DIM}  │${D}  ${Y}${B}╚═╝     ╚═╝  ╚═╝ ╚═════╝ ╚═╝     ╚═╝╚═╝        ╚═╝${D}                ${DIM}│${D}"
echo -e "${DIM}  │${D}                                                                      ${DIM}│${D}"
echo -e "${DIM}  │${D}         ${G}${B} █████╗ ██████╗ ███████╗     █████╗ ██╗${D}                    ${DIM}│${D}"
echo -e "${DIM}  │${D}         ${G}${B}██╔══██╗██╔══██╗██╔════╝    ██╔══██╗██║${D}                    ${DIM}│${D}"
echo -e "${DIM}  │${D}         ${G}${B}███████║██║  ██║███████╗    ███████║██║${D}                    ${DIM}│${D}"
echo -e "${DIM}  │${D}         ${C}${B}██╔══██║██║  ██║╚════██║    ██╔══██║██║${D}                    ${DIM}│${D}"
echo -e "${DIM}  │${D}         ${C}${B}██║  ██║██████╔╝███████║    ██║  ██║██║${D}                    ${DIM}│${D}"
echo -e "${DIM}  │${D}         ${C}${B}╚═╝  ╚═╝╚═════╝ ╚══════╝    ╚═╝  ╚═╝╚═╝${D}                    ${DIM}│${D}"
echo -e "${DIM}  │${D}                                                                      ${DIM}│${D}"
echo -e "${DIM}  │${D}     ${W}${B}⚡ AI-Native Contextual Ad Engine${D}                               ${DIM}│${D}"
echo -e "${DIM}  │${D}     ${DIM}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${D}                               ${DIM}│${D}"
echo -e "${DIM}  │${D}     ${DIM}Monetize your AI — no tracking, no cookies, no banners${D}           ${DIM}│${D}"
echo -e "${DIM}  │${D}                                                                      ${DIM}│${D}"
echo -e "${DIM}  │${D}     ${M}${B}by Abhishek Verma${D}                                               ${DIM}│${D}"
echo -e "${DIM}  │${D}                                                                      ${DIM}│${D}"
echo -e "${DIM}  │${D}     ${DIM}FastAPI · Next.js · Gemini · Qdrant · PostgreSQL · Redis${D}         ${DIM}│${D}"
echo -e "${DIM}  │${D}                                                                      ${DIM}│${D}"
echo -e "${DIM}  └──────────────────────────────────────────────────────────────────────┘${D}"
echo ""
